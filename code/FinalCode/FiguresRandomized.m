...
xlim([0 0.5]);
ylim([0 N]);
title('Randomized assets, random network')
legend('boxoff')
box on
grid on
hold off
...
xlim([0 0.5]);
ylim([0 N]);
title('Randomized assets, preferential network')
legend('boxoff')
box on
grid on
hold off
