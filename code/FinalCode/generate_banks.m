function [B, a, e, i, c, d, b, w] = generate_banks(N, p, gamma, theta, E,type)
%Function to generate values of the banking system. This is the vanilla bank
...
%random network or a scale free network.
if type == 0
