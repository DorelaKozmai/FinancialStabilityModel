%plot the vanilla figures. Quite some changes made from plot set ups of
%the previous group.
...
Y1=[meanfaults+sdfaults,fliplr(meanfaults-sdfaults)];
...
Y1=[meanfaults(1:nTheta)+sdfaults(1:nTheta),fliplr(meanfaults(1:nTheta)-sdfaults(1:nTheta))];
Y2=[meanfaults(nTheta+(1:nTheta))+sdfaults(nTheta+(1:nTheta)),fliplr(meanfaults(nTheta+(1:nTheta))-sdfaults(nTheta+(1:nTheta)))];
Y3=[meanfaults(2*nTheta+(1:nTheta))+sdfaults(2*nTheta+(1:nTheta)),fliplr(meanfaults(2*nTheta+(1:nTheta))-sdfaults(2*nTheta+(1:nTheta)))];
